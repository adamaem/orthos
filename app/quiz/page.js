...
const QUIZ_DEFAULT = {
  'Droit civil': [
    ...
    { q: "Qu'est-ce que la nullité relative ?", choices: ["Elle protège un intérêt privé et seule la partie protégée peut l'invoquer", "Elle sanctionne l'ordre public et tout intéressé peut l'invoquer", "Elle est prononcée d'office par le juge", "Elle rend le contrat inexistant"], answer: 0, explication: "La nullité relative protège un intérêt privé. Seule la partie que la loi entend protéger peut l'invoquer, contrairement à la nullité absolue." },
    { q: "Quelle condition n'est PAS requise pour la force majeure ?", choices: ["La prévisibilité", "L'irrésistibilité", "L'extériorité", "L'imprévisibilité"], answer: 0, explication: "La force majeure requiert l'imprévisibilité, l'irrésistibilité et l'extériorité. La prévisibilité est l'opposé de ce qui est requis." },
  ],
  'Droit constitutionnel': [
    { q: "En quelle année a été adoptée la Constitution française actuelle ?", choices: ["1958", "1946", "1789", "1962"], answer: 0, explication: "La Constitution de la Ve République a été adoptée le 4 octobre 1958, sous l'impulsion du général de Gaulle." },
    { q: "Qu'est-ce que le bloc de constitutionnalité ?", choices: ["La Constitution de 1958, la DDHC de 1789, le Préambule de 1946 et la Charte de l'environnement", "Uniquement la Constitution de 1958", "La Constitution et les lois organiques", "La Constitution et les traités internationaux"], answer: 0, explication: "Le bloc de constitutionnalité regroupe toutes les normes de valeur constitutionnelle servant de référence au contrôle de constitutionnalité." },
    { q: "Qui peut saisir le Conseil constitutionnel pour un contrôle a priori ?", choices: ["Le Président, le Premier ministre, les présidents des assemblées ou 60 parlementaires", "Tout citoyen français", "Uniquement le Président de la République", "Les juridictions ordinaires"], answer: 0, explication: "Depuis 1974, 60 députés ou 60 sénateurs peuvent saisir le Conseil constitutionnel, en plus des 4 autorités politiques traditionnelles." },
    { q: "Qu'est-ce que la QPC ?", choices: ["Question Prioritaire de Constitutionnalité", "Question Préalable de Constitutionnalité", "Question Principale de Constitutionnalité", "Question Particulière de Constitutionnalité"], answer: 0, explication: "La QPC (Question Prioritaire de Constitutionnalité) permet à tout justiciable de contester la constitutionnalité d'une loi lors d'un procès." },
  ],
  'Droit pénal': [
    { q: "Quel est le principe fondamental du droit pénal concernant les infractions ?", choices: ["Nullum crimen, nulla poena sine lege", "Nemo censetur ignorare legem", "In dubio pro reo", "Actus reus"], answer: 0, explication: "Le principe de légalité des délits et des peines (nullum crimen, nulla poena sine lege) signifie qu'il n'y a pas d'infraction ni de peine sans texte." },
    { q: "Devant quelle juridiction sont jugés les crimes ?", choices: ["La cour d'assises", "Le tribunal correctionnel", "Le tribunal de police", "La cour d'appel"], answer: 0, explication: "Les crimes sont jugés par la cour d'assises, composée de magistrats professionnels et d'un jury populaire." },
    { q: "Quels sont les éléments constitutifs d'une infraction pénale ?", choices: ["Élément légal, matériel et moral", "Élément matériel et intentionnel uniquement", "Élément légal et matériel uniquement", "Élément moral et intentionnel"], answer: 0, explication: "Toute infraction pénale nécessite trois éléments cumulatifs : légal (texte), matériel (acte) et moral (intention ou imprudence)." },
  ],
  'Droit administratif': [
    { q: "Quelle est la juridiction administrative suprême en France ?", choices: ["Le Conseil d'État", "La Cour de cassation", "Le Conseil constitutionnel", "La Cour administrative d'appel"], answer: 0, explication: "Le Conseil d'État est la juridiction administrative suprême. Il est aussi le conseiller juridique du gouvernement." },
    { q: "Quelles sont les lois de Rolland régissant le service public ?", choices: ["Continuité, égalité et mutabilité", "Continuité, neutralité et gratuité", "Égalité, efficacité et neutralité", "Continuité, transparence et égalité"], answer: 0, explication: "Les trois lois de Rolland sont : la continuité (le service ne doit pas s'interrompre), l'égalité (tous les usagers sont traités de la même façon) et la mutabilité (adaptabilité aux besoins)." },
  ],
}
    ...
    <main className="min-h-screen bg-[#f4f5f7] font-sans">
              ...
              <div key={cat} className="bg-white border border-gray-200 rounded-2xl p-6 hover:border-[#1a2e5a] transition">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button onClick={() => startQuiz(cat)}
                    className="bg-[#1a2e5a] text-white px-4 py-2 rounded-lg text-sm font-medium hover:opacity-90 transition">
                    Commencer →
                  </button>
                </div>
              </div>
      ...
      {mode === 'generate' && (
        <div className="max-w-2xl mx-auto px-8 py-16">
          <button onClick={() => setMode('home')} className="text-sm text-gray-400 hover:text-[#1a2e5a] mb-6 flex items-center gap-1">
            ← Retour
          </button>
      ...
      {mode === 'quiz' && !finished && question && (
        <div className="max-w-2xl mx-auto px-8 py-12">
          <div className="flex items-center justify-between mb-6">
            <button onClick={() => setMode('home')} className="text-sm text-gray-400 hover:text-[#1a2e5a]">← Quitter</button>
        ...
        <div className="max-w-xl mx-auto px-8 py-16 text-center">
          <div className="bg-white border border-gray-200 rounded-2xl p-10">
            ...
            <div className="flex gap-4 justify-center">
              <button onClick={() => startQuiz(selectedCat)}
